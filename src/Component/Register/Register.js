    ...
    return (
        <div className="container" style={{height:"800px",width:"100%"}}>
            <div className="row-form">
                ...
                <div className="card" style={{width:"80%",justifyContent:"center",display:"flex"}}>
                    <div className="card-body">
                        <div className="form-group">
                            <label>Email:</label><br/>
                            <input placeholder="VD:email@example.com" name="emailId" type="email" className="form-control"  style={{opacity:"30",position:"relative"}}
                                value={getEmail} onChange={(e)=>{setEmail(e.target.value)}} required/>
                        </div>
                        <div className="form-group">
                            <label>Họ và tên:</label>
                            <input placeholder="Họ và tên của bạn" name="fullName" className="form-control" style={{opacity:"30",position:"relative"}}
                                value={getFullName} onChange={(e)=>{setFullName(e.target.value)}} required></input>
                        </div>
                        <div className="form-group">
                            <label>Mật Khẩu:</label>
                            <input placeholder="Mật khẩu của bạn" name="Password" type="password" className="form-control" style={{opacity:"30",position:"relative"}}
                                value={getPassword} onChange={(e)=>{setPassword(e.target.value)}} required></input>
                        </div>
                        <div className="form-group">
                            <label>Xác nhận mật khẩu:</label>
                            <input placeholder="Xác nhận mật khẩu của bạn" type="password" name="password" className="form-control" style={{opacity:"30",position:"relative"}}
